...
const GoogleButton = () => {
  ...
  return (
    <button type="button" className="flex gap-2 w-full justify-center border rounded-[8px] outline-none border-[#CED4DA] p-[10px] text-[14px] active:bg-[#e6ebf0] max-sm:text-[12px]">
